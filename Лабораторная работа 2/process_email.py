...
def process_email(email):
  ...
  for str in email:
    ...
    for str in email:
      ...
      # Нахождение индекса слова в словаре
      # получение массива индексов
      ans = np.where(vocabList == str)

      # Проверка, найдено ли слово в словаре
      if ans[0].size > 0:
        # Добавление индекса в список индексов слов
...
def email_features(word_indices):
  ...
  # Установить в 1-е элементы массива x, соответствующие индексы из word_indices
  x[word_indices] = 1
